        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-8">
              ...
              <p> {!! $artigo->resumo !!} </p>
              <strong>Artigo: </strong> <a href=" {{ url("storage/file/{$artigo->file}") }} " class="btn btn-outline-primary" target="_blank"><i class="far fa-file-pdf"> PDF</i></a> <br>
            </div>
            <div class="col-md-4">
              <div class="col-auto d-none d-lg-block">
                <img src=" {{ url("storage/capa/{$revista->capa}") }} " alt="..." class="bd-placeholder-img" width="200" height="250"; >
              </div>
            </div>
        </div>
        </div>
