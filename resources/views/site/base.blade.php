  ...
  <body>
    <div class="container">
      {{--
        ...
        {{-- <div class="jumbotron p-4 p-md-5 text-white rounded bg-dark jumbotron-with-background" style="background-image: url(http://www.californiafootgolfclub.com/static/img/footgolf-1.jpg); background-size: 100%;">
        ...
        {{-- <div class="col-md-12 px-2">
          ...
          <br>
          <br>
            <img src=" {{ asset('assets/img/logo.jpg') }} " alt="logo" class="">
        </div>  --}}

        <div class="col-md-12">
          <br><br><br>
          <div class="row no-gutters border rounded overflow-hidden  position-relative">
            <img src=" {{ asset('assets/img/headerergaomnes.jpeg') }} " alt="logo" class="img-fluid">
          </div>
      </div>
